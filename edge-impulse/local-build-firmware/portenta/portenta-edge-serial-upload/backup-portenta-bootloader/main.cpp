...
//mbed::DigitalOut led(LED1);
  ...
  mbed:: DigitalOut myLedBlue(PK_7); // blue
...
static String appEui = "xxxxxxxxxxx";
static String appKey = "xxxxxxxxxxxxxxxxxxxxxxxxx";
